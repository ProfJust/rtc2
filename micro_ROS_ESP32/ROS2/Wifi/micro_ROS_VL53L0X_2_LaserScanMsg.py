...
# -------------------------------------------
# usage
# # $2 ros2 run rtc2 micro_ROS_2_laserscan winkeleinstellung
# -------------------------------------------
...
class micro_ROS_Node(Node):
    ...
    def __init__(self):
        ...
        self.angle_given = int(sys.argv[1])

        print(f"Winkel {self.angle_given}")
    ...
    def broadcast_transform_timer_cb(self):
           ...
           t1.transform.translation.x = 0.062  # ca. 6,2cm
           t1.transform.translation.y = -0.067
           t1.transform.translation.z = 0.04   # ca. 4cm
           winkel_deg = self.angle_given # Grad
           print(f"Winkel 1: {self.angle_given}")
           ...
           t2.transform.translation.x = 0.062  # ca. 6,5cm
           t2.transform.translation.y = 0.067
           t2.transform.translation.z = 0.04   # ca. 4cm
           winkel_deg = -self.angle_given # Grad
           print(f"Winkel 2: {-self.angle_given}")

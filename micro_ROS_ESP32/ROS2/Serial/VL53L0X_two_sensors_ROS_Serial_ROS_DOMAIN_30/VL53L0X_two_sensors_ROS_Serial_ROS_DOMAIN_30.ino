...
// an einem ESP32
// sendet über Micro-ROS-Serial auf ROS_DOMAIN_ID 30
// OJ 10.1.25
//---------------------------------------------------
// tested as OK with 
...
void setup() {
  ...
  RCCHECK(rclc_publisher_init_default(
    &publisher1,
    &node,
    ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int32),   /* hier nicht msg1 */
    "range1"));
  ...
  RCCHECK(rclc_publisher_init_default(
    &publisher2,
    &node,
    ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int32),  /* hier nicht msg2 */
    "range2"));
